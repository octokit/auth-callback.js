...
1. Please make sure there is no [open issue](https://github.com/octokit/auth-callback.js/issues?utf8=%E2%9C%93&q=is%3Aissue) yet.
...
```shell
git clone https://github.com/<your account name>/auth-callback.js.git
cd auth-callback.js
npm install
```
...
- Submit a pull request from your topic branch to the main branch on the `octokit/auth-callback.js` repository.
- Be sure to tag any issues your pull request is taking care of / contributing to. Adding "Closes #123" to a pull request description will automatically close the issue once the pull request is merged in.

## Testing a pull request from github repo locally:

You can install `@octokit/auth-callback` from each pull request. Replace `[PULL REQUEST NUMBER]`:

```
npm install https://github.pika.dev/octokit/auth-callback.js/pr/[PULL REQUEST NUMBER]
```

Once you are done testing, you can revert back to the default module `@octokit/auth-callback` from npm with `npm install @octokit/auth-callback`
